...
def _resolve_config(cfg: Dict) -> Dict:
    ...
    if out["out_root"] is None:
        out["out_root"] = str(script_dir / "Data_NCLT_MultiSourceAsync_CTRA6_RealIMU_V2")
    return out
...
def main():
    ...
    print("=" * 100)
    print("Building NCLT multi-source async dataset (REAL IMU version)")
    ...
    save_cfg = dict(cfg)
    save_cfg["state_mode"] = "ctra6_latent_async_multisource_realimu"
